  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://thezzimvn.com/ko/terms" />
      </Head>
      ...
      <main className="policy-page">
        <div className="policy-container">
          ...
          <section className="policy-section">
            <h2>2. 일반 조항</h2>
            <p>The Zzim 웹사이트에 접속하고 이용함으로써, 사용자는 본 이용약관을 읽고, 이해하며, 동의한 것으로 간주됩니다.</p>
          </section>
          ...
          <section className="policy-section">
            <h2>7. 면책 조항</h2>
            <p>The Zzim은 천재지변, 전쟁, 정부 명령 등 불가항력적 원인으로 인한 서비스 중단에 대해 책임지지 않습니다.</p>
          </section>
